...
if(isset($_GET['id'])){
    ...
    if(!$result){
      ...
      $delete= "DELETE FROM agent_users WHERE id='$id'";
...
<img src="user_img/<?php echo "$image";?>" alt="Avatar" class="avatar"> 
  ...
  <a href="branch_list.php" class="active"><i class="fa fa-building" aria-hidden="true"></i>Branch List</a>
...
<!-- header -->
    ...
    $rs_result3=mysqli_query($con,"Select * from agent_users");
    ...
    $sql="Select * from agent_users limit ".$startinglimit.','.$numberPages;
        ...
        if($num>0){
          ...
          ?>
            <tr class="serial_number">
              ...
              <td>
                <a style="text-decoration: none;" class="del-btn" href="branch_list.php? id= <?php echo $result['id'] ?>"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
        <?php
          }
    ...
    <?php
          for ($i = 1; $i <= $totalPages; $i++) {
              ...
              echo '<a class="pagination-btn ' . $activeClass . '" href="branch_list.php?page=' . $i . '">' . $i . '</a>';
          }
    ?>
