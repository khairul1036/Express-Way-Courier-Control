...
<img src="user_img/<?php echo "$image";?>" alt="Avatar" class="avatar"> 
  ...
  <a href="requested_branch.php" class="active"><i class="fa fa-reply" aria-hidden="true"></i>Requested Branch</a>
...
<!-- header -->
    ...
    <div class="container">
      <div>
          <p class="text">Requested Branch List</p>
      </div>
      <div class="horizontal-line"></div>
    <?php
    if(isset($_SESSION['contact'])){
    ...
    $rs_result3=mysqli_query($con,"Select * from requested_agent_users");
    ...
    $sql="Select * from requested_agent_users limit ".$startinglimit.','.$numberPages;
        ...
        if($num>0){
          ...
          ?>
            <tr class="serial_number">
              ...
              <td>
                <a style="text-decoration: none;" class="check-btn" href="accept_requested_branch.php?id= <?php echo $result['id'] ?>"><i class="fa fa-check-square"></i></a>
                <a style="text-decoration: none;" class="del-btn" href="delete_requested_branch.php? id= <?php echo $result['id'] ?>"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
        <?php
          }
