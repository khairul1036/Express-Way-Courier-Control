...
if(isset($_GET['id'])){
    ...
    if(!$result){
      ...
      $delete= "DELETE FROM staff_users WHERE id='$id'";
...
<img src="user_img/<?php echo "$image";?>" alt="Avatar" class="avatar"> 
  ...
  <a href="staff_list.php" class="active"><i class="fa fa-users" aria-hidden="true"></i>Staff List</a>
...
<!-- header -->
    ...
    $rs_result3=mysqli_query($con,"Select * from staff_users");
    ...
    $sql="Select * from staff_users limit ".$startinglimit.','.$numberPages;
        ...
        if($num>0){
          ...
          ?>
            <tr class="serial_number">
              ...
              <td>
                <a style="text-decoration: none;" class="del-btn" href="staff_list.php? id= <?php echo $result['id'] ?>"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
        <?php
          }
    ...
    <?php
          for ($i = 1; $i <= $totalPages; $i++) {
              ...
              echo '<a class="pagination-btn ' . $activeClass . '" href="staff_list.php?page=' . $i . '">' . $i . '</a>';
          }
    ?>
