...
<img src="user_img/<?php echo "$image";?>" alt="Avatar" class="avatar"> 
  ...
  <a href="total_shipped.php"  class="active"><i class="fa fa-cubes" aria-hidden="true"></i>Total Shipped</a>
...
<!-- header -->
    ...
    $sql="Select * from parcels where status=1 AND from_branch_id='$id' limit ".$startinglimit.','.$numberPages;
    ...
    <?php
          for ($i = 1; $i <= $totalPages; $i++) {
              ...
              echo '<a class="pagination-btn ' . $activeClass . '" href="total_shipped.php?page=' . $i . '">' . $i . '</a>';
          }
    ?>
