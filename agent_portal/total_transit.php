...
<img src="user_img/<?php echo "$image";?>" alt="Avatar" class="avatar"> 
  ...
  <a href="total_transit.php"  class="active"><i class="fa fa-cubes" aria-hidden="true"></i>In-Transit</a>
...
<!-- header -->
    ...
    <div class="container">
    <div>
      <p class="text">Total In-Transit</p>
    </div>
    <div class="horizontal-line"></div>
    <?php
    if(isset($_SESSION['contact'])){
    ...
    $sql="Select * from parcels where status=2 AND from_branch_id='$id' limit ".$startinglimit.','.$numberPages;
    ...
    <?php
          for ($i = 1; $i <= $totalPages; $i++) {
              ...
              echo '<a class="pagination-btn ' . $activeClass . '" href="total_transit.php?page=' . $i . '">' . $i . '</a>';
          }
    ?>
