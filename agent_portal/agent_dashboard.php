...
<div id="mySidebar" class="sidebar">
  ...
  <div class="nav">
  <a href="agent_dashboard.php"  class="active"><i class="fa fa-tachometer" aria-hidden="true"></i>Dashboard</a>
          ...
          <div class="grid-container2">
            <h2 class="total">
              <?php
                ...
                $sql = "SELECT COUNT(*) AS parcel_count FROM parcels WHERE from_branch_id='$branch_id'"; 
        ...
        <div class="inside-box">
              <div class="grid-container2">
                <h2 class="total">
                  <?php
                    include('dbconnection.php');
                    $sql = "SELECT COUNT(*) AS parcel_count FROM parcels WHERE status=4 AND from_branch_id='$branch_id'"; 
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      $row = mysqli_fetch_assoc($result);
                      $count = $row['parcel_count'];
      ...
      <div class="box">
        <div class="inside-box">
                <div class="grid-container2">
                  ...
                  <?php
                    include('dbconnection.php');
                    $sql = "SELECT COUNT(*) AS parcel_count FROM parcels WHERE status=1 AND from_branch_id='$branch_id'"; 
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      $row = mysqli_fetch_assoc($result);
                      $count = $row['parcel_count'];
      ...
      <div class="box">
        <div class="inside-box">
                <div class="grid-container2">
                  ...
                  <?php
                    include('dbconnection.php');
                    $sql = "SELECT COUNT(*) AS parcel_count FROM parcels WHERE status=2 AND from_branch_id='$branch_id'"; 
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      $row = mysqli_fetch_assoc($result);
                      $count = $row['parcel_count'];
      ...
      <div class="box">
        <div class="inside-box">
                <div class="grid-container2">
                  ...
                  <?php
                    include('dbconnection.php');
                    $sql = "SELECT COUNT(*) AS parcel_count FROM parcels WHERE status=3 AND from_branch_id='$branch_id'"; 
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      $row = mysqli_fetch_assoc($result);
                      $count = $row['parcel_count'];
  ...
  <div class="grid-container2">
      <div class="box">
          <div class="inside-box">
                ...
                include('dbconnection.php');
                $branch_id=$_SESSION['id'];
                $sql = "SELECT COUNT(*) AS parcel_count FROM delete_parcels WHERE from_branch_id='$branch_id'"; 
                $result = mysqli_query($con, $sql);
                if ($result) {
                  $row = mysqli_fetch_assoc($result);
                  $count = $row['parcel_count'];
