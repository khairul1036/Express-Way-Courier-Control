...
<title>Unsuccessfull Delivery</title>
...
<img src="user_img/<?php echo "$image";?>" alt="Avatar" class="avatar"> 
  ...
  <a href="unsuccessfull_delivery.php" class="active"><i class="fa fa-cubes" aria-hidden="true"></i>Unsuccessfull</a>
...
<!-- header -->
    ...
    <div class="container">
    <div>
      <p class="text">Unsuccessfull Delivery</p>
    </div>
    <div class="horizontal-line"></div>
    ...
    $sql="Select * from parcels where status=3 AND from_branch_id='$id' limit ".$startinglimit.','.$numberPages;
    ...
    <?php
          for ($i = 1; $i <= $totalPages; $i++) {
              ...
              echo '<a class="pagination-btn ' . $activeClass . '" href="unsuccessfull_delivery.php?page=' . $i . '">' . $i . '</a>';
          }
    ?>
