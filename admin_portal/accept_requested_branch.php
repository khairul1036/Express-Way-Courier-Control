...
if(isset($_GET['id'])){
    ...
    if(!$result){
      ...
      $sql = "Select * from requested_agent_users where id='$id'";
      ...
      $query = "INSERT INTO agent_users(first_name, last_name, org_name, org_type, state_address, post_office, zip_code, district, city, contact, image) 
      ...
      if(mysqli_query($con,$delete)){
        ...
        header("Location: branch_list.php?echo 'Branch Add Successful'");
        exit();
      }
      else{
